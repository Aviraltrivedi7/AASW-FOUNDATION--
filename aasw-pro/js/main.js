...
const translations = {
  ...
  'w-p1': { en: 'AASW Foundation catalyses exchange of knowledge and best practices, facilitates meaningful partnerships, and promotes grassroots leadership to build a more equitable India.', hi: 'AASW फाउंडेशन ज्ञान और सर्वोत्तम प्रथाओं के आदान-प्रदान को उत्प्रेरित करता है, सार्थक साझेदारियों को सुविधाजनक बनाता है, और अधिक समतामूलक भारत के निर्माण के लिए जमीनी स्तर के नेतृत्व को बढ़ावा देता है।' },
  ...
  'e-p1': { en: 'AASW Foundation is a unique nonprofit society owned, managed, and dedicated entirely to the benefit of India\'s most underserved communities — united by a common goal to innovate, catalyse meaningful partnerships, share knowledge, and achieve collective impact.', hi: 'AASW फाउंडेशन एक अनोखी गैर-लाभकारी संस्था है जो पूरी तरह से भारत के सबसे वंचित समुदायों के कल्याण के लिए समर्पित है - जो नवाचार करने, सार्थक साझेदारियों को बढ़ावा देने, ज्ञान साझा करने और सामूहिक प्रभाव हासिल करने के एक सामान्य लक्ष्य से एकजुट है।' },
  ...
  'ov-h2': { en: 'Building an Equitable India, One Community at a Time', hi: 'एक समय में एक समुदाय के साथ एक समतामूलक भारत का निर्माण' },
  'ov-p1': { en: 'AASW Foundation unites communities, changemakers, and institutions around a cohesive vision of inclusive development. Our focused, evidence-based approach allows for meaningful progress across four Indian states.', hi: 'AASW फाउंडेशन समावेशी विकास के एक साझा दृष्टिकोण के चारों ओर समुदायों, बदलाव लाने वालों और संस्थानों को एकजुट करता है। हमारा केंद्रित, साक्ष्य-आधारित दृष्टिकोण हमें चार भारतीय राज्यों में सार्थक प्रगति करने में सक्षम बनाता है।' },
  ...
  'testi-sub': { en: 'Real stories from communities, beneficiaries, and partners who have experienced the AASW Foundation difference.', hi: 'समुदायों, लाभार्थियों और भागीदारों की वास्तविक कहानियां जिन्होंने AASW फाउंडेशन के माध्यम से आए बदलाव का अनुभव किया है।' },
  't1-text': { en: '"The Shakti program changed everything for me. I now run my own tailoring business and send my children to school. AASW Foundation gave me the confidence to believe in myself."', hi: '"शक्ति कार्यक्रम ने मेरे लिए सब कुछ बदल दिया। अब मैं अपना सिलाई व्यवसाय चलाती हूं और अपने बच्चों को स्कूल भेजती हूं। AASW फाउंडेशन ने मुझे खुद पर विश्वास करने का आत्मविश्वास दिया।"' },
  ...
  't2-text': { en: '"AASW Foundation is a model of transparency and community engagement. Partnering with them for our CSR initiatives has been one of our best decisions."', hi: '"AASW फाउंडेशन पारदर्शिता और सामुदायिक भागीदारी का एक बेहतरीन उदाहरण है। अपनी CSR पहलों के लिए उनके साथ साझेदारी करना हमारे सबसे अच्छे निर्णयों में से एक रहा है।"' },
  't2-name': { en: 'Ramesh Gupta', hi: 'रमेश गुप्ता' },
  't2-role': { en: 'Head of CSR, Sunrise Industries Ltd.', hi: 'CSR प्रमुख, सनराइज इंडस्ट्रीज' },
  't3-text': { en: '"Before the mobile health camp, we had to travel 40 km for medical help. Today we have regular check-ups and our mothers are healthier."', hi: '"मोबाइल स्वास्थ्य शिविर से पहले, हमें इलाज के लिए 40 किमी की यात्रा करनी पड़ती थी। आज हमारी नियमित जांच होती है और हमारी माताएं अधिक स्वस्थ हैं।"' },
  ...
  'f-about': { en: 'We believe that community, compassion, and consistent action can make a significant positive impact on India\'s social and economic well-being.', hi: 'हमारा मानना है कि समुदाय, करुणा और निरंतर प्रयास भारत के सामाजिक और आर्थिक कल्याण पर एक महत्वपूर्ण सकारात्मक प्रभाव डाल सकते हैं।' },
  ...
  'team-collective': { en: 'The Collective', hi: 'सामूहिक दल' },
  ...
  'team-select-desc': { en: 'Select a category to explore our dedicated leaders.', hi: 'हमारे समर्पित नेताओं को जानने के लिए एक श्रेणी चुनें।' },
